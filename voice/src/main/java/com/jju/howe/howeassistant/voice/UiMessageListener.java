package com.jju.howe.howeassistant.voice;
...
public class UiMessageListener extends MessageListener {
    ...
    public interface speakFinListener{
        void finish();
    }

    private Handler mainHandler;
    private speakFinListener mSpeakFinListener;

    private static final String TAG = "UiMessageListener";

    public UiMessageListener(Handler mainHandler,speakFinListener listener) {
        super();
        this.mainHandler = mainHandler;
        this.mSpeakFinListener = listener;
    }
